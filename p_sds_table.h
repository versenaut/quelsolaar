...
extern void p_sds_ts_copy_vertex(weight_polygon *read, egreal *target, uint vertex1);
extern void p_sds_ts_divide_edge(weight_polygon *read, egreal *target, uint vertex1, uint vertex2);
extern void p_sds_ts_create_middel_vertex(weight_polygon *read, egreal *target);
