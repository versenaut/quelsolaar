...
extern void			sds_test_draw(PPolyStore *mesh, egreal *vertex);

extern PPolyStore	*compute(PPolyStore *mesh, uint *ref, uint ref_count, egreal *vertex, uint vertex_count, uint32 *edge_crease, uint version);
