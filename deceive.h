...
extern void	deceve_add_login(const char *address, const char *name, const char *pass);
extern void	deceive_set_arg(int argc, char **argv);
extern ENode *	deceive_get_edit_node(void);

extern void	deceive_save_bookmarks(const char *file_name);
extern void	deceive_load_bookmarks(const char *file_name);
